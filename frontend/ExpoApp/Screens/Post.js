    ...
    >
      <View style={joinstyles.container}>
        ...
        <View style={joinstyles.header}>
          ...
          {/* post btn */}
          <TouchableOpacity style={joinstyles.right}></TouchableOpacity>
        </View>
        {/* post */}
        <View style={joinstyles.post}>
          ...
          <View style={joinstyles.profile}>
            ...
            >
              {avatar ? (
                <Image src={avatar} style={joinstyles.profileImage} />
              ) : (
                <Image
          ...
          {/* text input */}
          <Text style={joinstyles.feelinginput}>{caption}</Text>
          {/* Photos */}
          ...
          <View style={joinstyles.info}>
            ...
            <Text style={joinstyles.taskAddrtext}>
